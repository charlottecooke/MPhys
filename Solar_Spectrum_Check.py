...
Flux_per_Wavelength = df2.iloc[1:,1]
...
I_max = sum(I)*10**-4
# max theoretical current in units of A/cm^2 disregarding electrons below 1.24eV

print('Maximum theoretical current is', I_max, 'A/cm^2')
...
I_T_max = sum(I_T)*10**-4
# max total current, without taking bandgap into account, in units of A/cm^2
